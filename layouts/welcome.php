            ...
            <?php if ($muncul) : ?>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link" href="http://<?= $_SERVER['HTTP_HOST'] ?>/bk-poliklinik-main/pages/<?= $arah ?>">Dashboard</a></li>
                    </ul>
                </div>
            <?php endif ?>
        </div>
            ...
            <div class="container px-5 my-5">
                <div class="row gx-5">
                    <div class="col-lg mb-5 mb-lg-0">
                        ...
                        <a class="text-decoration-none" href="http://<?= $_SERVER['HTTP_HOST'] ?>/bk-poliklinik-main/pages/auth/register.php">
                            Klik Link Berikut
                    ...
                    <div class="col-lg mb-5 mb-lg-0">
                        ...
                        <a class="text-decoration-none" href="http://<?= $_SERVER['HTTP_HOST'] ?>/bk-poliklinik-main/pages/auth/login.php">
                            Klik Link Berikut
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>

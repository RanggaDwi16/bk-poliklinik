...
<script>
  ...
  function loadJadwal(poliId) {
    ...
    // xhr.open('GET', 'http://localhost/bk-poliklinik-main/pages/pasien/poli/get_jadwal.php?poli_id=' + poliId, true);
    xhr.open('GET', 'http://' + window.location.host + '/bk-poliklinik-main/pages/pasien/poli/get_jadwal.php?poli_id=' + poliId, true);
